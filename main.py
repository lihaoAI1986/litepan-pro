...
from api.path_play import router as path_play_router
...
# /d/{account_id}/{file_path} 302 反代入口（TgtoDrive 风格，path-based）
app.include_router(path_play_router, tags=["v3 Path Play"])
